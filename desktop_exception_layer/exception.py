...
class GenericException(Exception):
    ...
    def error_message_detail(self, error, error_detail):
        """This fuction raise error message

        Args:
            error (_str_): your error message
            error_detail (_str_): error detail message
        ...
        error_message = "python script name [{0}] line number [{1}] error message [{2}]".format(file_name, exc_tb.tb_lineno,
                                                                                       str(error))
